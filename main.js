...
function setSummer() {
    ...
    activeBtn("springBtn", "summerBtn", "autumnBtn", "winterBtn");
...
function activeBtn(spring, summer, autumn, winter) {
    document.getElementById(spring).classList.remove('activeBtn');
    document.getElementById(summer).classList.remove('activeBtn');
    document.getElementById(autumn).classList.remove('activeBtn');
    document.getElementById(winter).classList.remove('activeBtn');
}
